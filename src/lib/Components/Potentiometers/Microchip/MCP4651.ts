 ...
 */
export default class MCP4651 extends MicrochipPotentiometerBase {
    /**
     * Initializes a new instance of the MCP4651 class wit the I2C device that
     * is the connection to the MCP4651, whether the address pin A0 is high or
     ...
     * @constructor
     */
	constructor(device: II2C, pinA0: boolean = false, pinA1: boolean = false, pinA2: boolean = false,
		channel: MicrochipPotChannel = MicrochipPotChannel.NONE, initialValue: number = 0) {
        super(
            device,
            pinA0,
            pinA1,
     ...
     * @override
     */
    public get isNonVolatileWiperCapable() { return false; }
     ...
     * @override
     */
    public get maxValue() { return 256; }
     ...
     * @override
     */
    public get isRheostat() { return false; }
     ...
     * @override
     */
    public get supportedChannels() { return SUPPORTED_CHANNELS; }
}