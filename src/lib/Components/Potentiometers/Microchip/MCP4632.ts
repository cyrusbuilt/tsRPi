 ...
 */
export default class MCP4632 extends MicrochipPotentiometerBase {
    /**
     ...
     * @constructor
     */
	constructor(device: II2C, pinA0: boolean = false, pinA1: boolean = false,
     ...
     * @override
     */
    public get maxValue() { return 128; }
     ...
     * @override
     */
    public get isRheostat() { return true; }
